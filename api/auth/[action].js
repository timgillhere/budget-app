// Single dynamic-segment handler for all /api/auth/* routes.
// Vercel sets req.query.action to the path segment, e.g. "me", "mfa-setup", etc.
// All auth routes are single-segment so [action].js covers every case.
// Consolidates 7 files into 1 to stay within the Vercel Hobby 12-function limit.
